...
import 'package:alamuti/presentation/details/fullscreen_image.dart';
import 'package:alamuti/presentation/details/fullscreen_slider.dart';
...
class _DetailScreenState extends State<DetailScreen> with CacheManager {
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      ...
                      if (group != null && group.isDeleted == true) {
                        ...
                        Get.to(() => ChatScreen(signalRHelper: signalRHelper),
