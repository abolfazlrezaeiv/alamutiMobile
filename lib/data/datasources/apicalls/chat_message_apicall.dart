...
class MessageProvider with CacheManager {
  RefreshTokenApiCall tokenProvider = Get.put(RefreshTokenApiCall());
  ...
  Future<ListPage<ChatMessage>> getGroupMessages(
    ...
    return ListPage<ChatMessage>(
        itemList: listMessagesFromApi, totalPages: xPagination['TotalCount']);
  }
  ...
  Future<ListPage<ChatGroup>> getGroups({int number = 1, int size = 10}) async {
    ...
    return ListPage(
        itemList: listGroupsFromApi, totalPages: xPagination['TotalCount']);
  }
